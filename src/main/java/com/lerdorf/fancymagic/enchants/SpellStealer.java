...
public class SpellStealer implements FancyEnchant {
	public static final Key KEY = Key.key("fancymagic:spellstealer");
   ...
   public SpellStealer(
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("fancymagic.enchant.spellstealer", "Spell Stealer");
    }
    ...
    public @NotNull TagKey<ItemType> getTagForSupportedItems() {
        return TagKey.create(RegistryKey.ITEM, Key.key("fancymagic:spellstealer_enchantable"));
    }
    ...
    public static SpellStealer create() {
    	SpellStealer spellStealerEnchant = new SpellStealer(
                1, // anvil cost
                1, // weight
            ...
            FancyMagic.ENCHANTS.put(SpellStealer.KEY, spellStealerEnchant);

        return spellStealerEnchant;
    }
}
