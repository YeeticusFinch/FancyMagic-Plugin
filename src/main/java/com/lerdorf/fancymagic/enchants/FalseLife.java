...
public class FalseLife implements FancyEnchant {
	public static final Key KEY = Key.key("fancymagic:falselife");
    ...
    private final int extraHealthPerLevel;
   ...
   public FalseLife(
        ...
        this.extraHealthPerLevel = extraHealthPerLevel;
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("fancymagic.enchant.falselife", "False Life");
    }
    ...
    public int getExtraHealthPerLevel() {
        return extraHealthPerLevel;
    }
    ...
    public @NotNull TagKey<ItemType> getTagForSupportedItems() {
        return TagKey.create(RegistryKey.ITEM, Key.key("fancymagic:falselife_enchantable"));
    }
    ...
    public static FalseLife create() {
        FalseLife falseLifeEnchant = new FalseLife(
                1, // anvil cost
                1, // weight
                ...
                5, // max level
                2 // extra health per level
        );

            FancyMagic.ENCHANTS.put(FalseLife.KEY, falseLifeEnchant);

        return falseLifeEnchant;
    }
}
