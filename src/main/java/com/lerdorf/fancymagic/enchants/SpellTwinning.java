...
public class SpellTwinning implements FancyEnchant {
	public static final Key KEY = Key.key("fancymagic:spelltwinning");
   ...
   public SpellTwinning(
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("fancymagic.enchant.spelltwinning", "Spell Twinning");
    }
    ...
    public @NotNull TagKey<ItemType> getTagForSupportedItems() {
        return TagKey.create(RegistryKey.ITEM, Key.key("fancymagic:spelltwinning_enchantable"));
    }
    ...
    public static SpellTwinning create() {
    	SpellTwinning spellTwinningEnchant = new SpellTwinning(
                1, // anvil cost
                1, // weight
            ...
            FancyMagic.ENCHANTS.put(SpellTwinning.KEY, spellTwinningEnchant);

        return spellTwinningEnchant;
    }
}
