...
public class Spellbound implements FancyEnchant {
	public static final Key KEY = Key.key("fancymagic:spellbound");
    ...
    private final double chanceToDropSpellPerLevel;
   ...
   public Spellbound(
            ...
            int maxLevel,
            double chanceToDropSpellPerLevel
    ) {
        ...
        this.chanceToDropSpellPerLevel = chanceToDropSpellPerLevel;
    ...
    public @NotNull Component getDescription() {
        return Component.translatable("fancymagic.enchant.spellbound", "Spellbound");
    }
    ...
    public double getChanceToDropSpellPerLevel() {
        return chanceToDropSpellPerLevel;
    }
    ...
    public @NotNull TagKey<ItemType> getTagForSupportedItems() {
        return TagKey.create(RegistryKey.ITEM, Key.key("fancymagic:spellbound_enchantable"));
    }
    ...
    public static Spellbound create() {
        Spellbound spellboundEnchant = new Spellbound(
                1, // anvil cost
                1, // weight
